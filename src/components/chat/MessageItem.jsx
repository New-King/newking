  ...
  if (message.role === 'user') {
    return (
      <div className="flex justify-end">
        <div className="max-w-[75%] animate-fade-in-up whitespace-pre-wrap rounded-2xl rounded-br-md bg-neutral-900 px-4 py-2.5 text-[15px] leading-relaxed text-white">
          {message.text}
        </div>
      </div>
    );
